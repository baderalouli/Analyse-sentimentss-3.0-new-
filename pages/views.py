...
driver = GraphDatabase.driver("bolt://18.208.197.42:7687", auth=("neo4j", "farm-calibrations-stove"))
...
def about(request):
    if request.method == 'POST':
        ...
        # Formater les pourcentages avec 2 chiffres après la virgule
